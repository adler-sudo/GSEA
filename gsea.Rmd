...
**What does the plot tell you about components of this pathway and male pregnancy?** The plot provides us with a visualization of the components of this pathway, the effect that they have on each other, and the final product or action from the pathway. The colored rectangles represent genes in our analysis of male pregnancy, colored according to the magnitude of the log2 fold change observed in our study.
...
**What do you think is meant by "convergence"?** 
...
**Are there any groups of genes that differentiate between pregnant and non-pregnant males particularly well? If so, name those genes?** The top quarter(ish) of the plot appears to cluster fairly consistently between the two groups. These genes include the top branch at the point the there are 5 branches. These genes include complement component 6,kininogen, coagulation factor V, coagulation factor III, C5a anaphylatoxin chemotactic receptor, thrombomodulin,clusterin, fibinogen gamma chain, decay accelerating factor, and compound factor D.
...
**Does your heatmap look any different? If so, explain why this might be.** Yes, the heatmap and dendrogram are very different. The NP and P samples are no longer clustered together. The range of values in the heatmap is much narrower. This is likely a result of major skew in the original data. 
...
# subset to groupXIX and between 6000000-12000000 gene start position=
stick_TMMvals.random = stick_TMMvals[sample(nrow(stick_TMMvals),length(names_compcoag)),]

# reduce pouch_compcoag to CPM values 
stick_TMMvals.random = stick_TMMvals.random[,!names(stick_TMMvals.random) %in% c("Genome_Loc","Gene_Start_Pos")]
